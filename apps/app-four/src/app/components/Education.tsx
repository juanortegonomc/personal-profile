    ...
    <section id="education" className="py-24 px-6 bg-white/[0.02]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {/* Education */}
          <div>
            <h3 className="text-white/50 text-xs uppercase tracking-widest font-mono mb-5">
              Education
            </h3>
            <div className="space-y-4">
              {profile.education.map((edu) => (
                ...
                >
                  ...
                  <p className="gradient-text text-sm mt-1">
                    {edu.institution}
                  </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              {profile.certifications.map((cert) => (
                <div
                  key={cert.code}
                  className="glass rounded-2xl p-5 glass-hover flex gap-4 items-start"
                >
            ...
            {/* Languages */}
            <h3 className="text-white/50 text-xs uppercase tracking-widest font-mono mb-5 mt-8">
              Languages
            </h3>
            <div className="space-y-4">
